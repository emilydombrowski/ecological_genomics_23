...
setwd("~/Documents/UVM/ecological_genomics_23/transcriptomics/gomwu")
...
# filtering read depths, reduces the amount of reads processed and saves statistical power
nrow(dds) 
...
# handles genIDs and their naming conventions to reconstruct files
...
# quote false is important, rownames is also important
