...
mean(rowSums(countsTableRound)) # [1] 8217.17
...
dds <- dds[rowSums(counts(dds) >= 15) >= 28,] # 30 determined by looking at histogram
nrow(dds) 
# 25260, that have at least 15 reads (aka counts) in 75% of samples
...
### Check the quality o fhte data by sample clustering and visualization
...
# shows normalizations. Used for making PCA plots 

# Variance stabilizing transformation
vsd <- vst(dds, blind=FALSE)
meanSdPlot(assay(vsd))
# more variance in this rather than the other
...
# is there a statistical way to test these?
...
# Function built into DNAseq2
# can also be used to pull out variation
...
# creates variable to pull out data 
...
ggplot(pcaData, aes(PC1, PC2, color=treatment, shape=generation)) +
  ...
  coord_fixed()
# first global view of data
# no overall clustering based on treatment, mostly based on generation


#################################

### Make a more advanced PCA
...
# the following code allows us to save as a .png!
...
### Check on DE results from the Deseq command way above
...
# baseMean log2FoldChange     lfcSE
# <numeric>      <numeric> <numeric>
#   TRINITY_DN1938_c0_g1::TRINITY_DN1938_c0_g1_i18::g.9836::m.9836     259.9095    1.08333e-01  0.129291
# TRINITY_DN5911_c0_g1::TRINITY_DN5911_c0_g1_i17::g.23209::m.23209   138.4247    1.33678e-02  0.108440
# TRINITY_DN209_c2_g1::TRINITY_DN209_c2_g1_i3::g.1533::m.1533         45.6569   -8.10373e-03  0.187617
# TRINITY_DN10154_c0_g2::TRINITY_DN10154_c0_g2_i1::g.33548::m.33548   29.6715   -4.58357e-01  0.370513
# TRINITY_DN6614_c0_g1::TRINITY_DN6614_c0_g1_i5::g.25280::m.25280     53.9376    2.36737e-05  0.600981
# TRINITY_DN6542_c3_g1::TRINITY_DN6542_c3_g1_i3::g.24952::m.24952     40.5470    5.04384e-02  0.249684
# stat    pvalue      padj
# <numeric> <numeric> <numeric>
#   TRINITY_DN1938_c0_g1::TRINITY_DN1938_c0_g1_i18::g.9836::m.9836     8.37898e-01  0.402088  0.999278
# TRINITY_DN5911_c0_g1::TRINITY_DN5911_c0_g1_i17::g.23209::m.23209   1.23275e-01  0.901890  0.999278
# TRINITY_DN209_c2_g1::TRINITY_DN209_c2_g1_i3::g.1533::m.1533       -4.31930e-02  0.965548  0.999984
# TRINITY_DN10154_c0_g2::TRINITY_DN10154_c0_g2_i1::g.33548::m.33548 -1.23709e+00  0.216055        NA
# TRINITY_DN6614_c0_g1::TRINITY_DN6614_c0_g1_i5::g.25280::m.25280    3.93917e-05  0.999969  0.999991
# TRINITY_DN6542_c3_g1::TRINITY_DN6542_c3_g1_i3::g.24952::m.24952    2.02009e-01  0.839910  0.999278
...
d <-plotCounts(dds, gene="TRINITY_DN209_c2_g1::TRINITY_DN209_c2_g1_i3::g.1533::m.1533", intgroup = (c("treatment","generation")), returnData=TRUE)
d
...
dim(dds_sub)
# [1] 25260 x 12 <- 12 sample instead of 38 from before
...
# By environment
# run on subsetted DDS
vsd <- vst(dds_sub, blind=FALSE)

topgenes <- head(rownames(res_F0_OWvAM),20) # pulling out top 20 genes. can also use p-vals
mat <- assay(vsd)[topgenes,]
mat <- mat - rowMeans(mat) # maing a matix of top genes
df <- as.data.frame(colData(dds_sub)[,c("generation","treatment")]) # maing a data frame of the data for labelling
pheatmap(mat, annotation_col=df)
pheatmap(mat, annotation_col=df, cluster_cols = F)
# changing cluster_cols changes and removes dendrogram
...
# expectation: most similarity between the warming and the combined trial
# homework question: do the same thing for f4 or f11
...
summary(res_F0_OWvAM)
res_F0_OWvAM <- res_F0_OWvAM[!is.na(res_F0_OWvAM$padj),] # filters out na
degs_F0_OWvAM <- row.names(res_F0_OWvAM[res_F0_OWvAM$padj < 0.05,])
# saves genes that are significant as DEGs
...
# total - intersections - intersections + overlap
