...
# saved as ahud_WGCNA_hw.R to scripts
# point of this assignment: alter power thresholds for WGCNA
...
# design as 1: WGCNA, excludes meta data so WGCNA can be agnostic 
...
# TRUE for both outcomes

# perform variance stabilization
dds_norm <- vst(dds)
# dds_norm <- vst(normalized_counts)
# normalizes data and extracts and transposes normalized counts
...
# generates set of things to test
power <- c(c(1:10), seq(from = 12, to = 50, by = 2))

# Call the network topology analysis function; this step takes a couple minutes
# signed: looks at up vs. down regulation, or positive vs. negative
# potential for homework: does unsigned affect things?
...
# ideally your maxBlockSize is larger than your number of genes to run the memory-intensive network construction all at once.
...
# the most in turquoise (9806)
table(bwnet$colors)

# black      blue     brown     green      grey   magenta      pink 
# 233      7919      3614       367      1588       144       164 
...
hubs
# prints out top genes: genes associated with each moduole
