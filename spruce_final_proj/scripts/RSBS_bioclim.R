## script for associating bioclim factors with RS and BS populations
...
coords <- read.csv("~/Documents/UVM/ecological_genomics_23/spruce_final_proj/data/RSBScombinedmetadata.csv", header=T)
